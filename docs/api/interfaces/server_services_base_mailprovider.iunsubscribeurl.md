...
Defined in: [server/services/base/MailProvider.ts:33](https://github.com/onzag/itemize/blob/3efa2a4a/server/services/base/MailProvider.ts#L33)
...
Defined in: [server/services/base/MailProvider.ts:28](https://github.com/onzag/itemize/blob/3efa2a4a/server/services/base/MailProvider.ts#L28)
