[@onzag/itemize](../README.md) / [Modules](../modules.md) / [client/components/item/DifferingIncludesRetriever](../modules/client_components_item_DifferingIncludesRetriever.md) / IDifferingIncludeInfo
