[@onzag/itemize](../README.md) / [Modules](../modules.md) / [client/internal/text/serializer/types/table](../modules/client_internal_text_serializer_types_table.md) / ITh

# Interface: ITh

[client/internal/text/serializer/types/table](../modules/client_internal_text_serializer_types_table.md).ITh
...
- [blur](client_internal_text_serializer_types_table.ITh.md#blur)
- [children](client_internal_text_serializer_types_table.ITh.md#children)
- [click](client_internal_text_serializer_types_table.ITh.md#click)
- [context](client_internal_text_serializer_types_table.ITh.md#context)
- [focus](client_internal_text_serializer_types_table.ITh.md#focus)
- [forEach](client_internal_text_serializer_types_table.ITh.md#foreach)
- [givenName](client_internal_text_serializer_types_table.ITh.md#givenname)
- [html](client_internal_text_serializer_types_table.ITh.md#html)
- [ifCondition](client_internal_text_serializer_types_table.ITh.md#ifcondition)
- [input](client_internal_text_serializer_types_table.ITh.md#input)
- [keydown](client_internal_text_serializer_types_table.ITh.md#keydown)
- [keypress](client_internal_text_serializer_types_table.ITh.md#keypress)
- [keyup](client_internal_text_serializer_types_table.ITh.md#keyup)
- [mousedown](client_internal_text_serializer_types_table.ITh.md#mousedown)
- [mouseenter](client_internal_text_serializer_types_table.ITh.md#mouseenter)
- [mouseleave](client_internal_text_serializer_types_table.ITh.md#mouseleave)
- [mousemove](client_internal_text_serializer_types_table.ITh.md#mousemove)
- [mouseout](client_internal_text_serializer_types_table.ITh.md#mouseout)
- [mouseover](client_internal_text_serializer_types_table.ITh.md#mouseover)
- [mouseup](client_internal_text_serializer_types_table.ITh.md#mouseup)
- [mousewheel](client_internal_text_serializer_types_table.ITh.md#mousewheel)
- [richClassList](client_internal_text_serializer_types_table.ITh.md#richclasslist)
- [style](client_internal_text_serializer_types_table.ITh.md#style)
- [styleActive](client_internal_text_serializer_types_table.ITh.md#styleactive)
- [styleHover](client_internal_text_serializer_types_table.ITh.md#stylehover)
- [textContent](client_internal_text_serializer_types_table.ITh.md#textcontent)
- [touchcancel](client_internal_text_serializer_types_table.ITh.md#touchcancel)
- [touchend](client_internal_text_serializer_types_table.ITh.md#touchend)
- [touchmove](client_internal_text_serializer_types_table.ITh.md#touchmove)
- [touchstart](client_internal_text_serializer_types_table.ITh.md#touchstart)
- [type](client_internal_text_serializer_types_table.ITh.md#type)
- [uiHandler](client_internal_text_serializer_types_table.ITh.md#uihandler)
- [uiHandlerArgs](client_internal_text_serializer_types_table.ITh.md#uihandlerargs)
- [wheel](client_internal_text_serializer_types_table.ITh.md#wheel)
...
[client/internal/text/serializer/types/table.ts:531](https://github.com/onzag/itemize/blob/59702dd5/client/internal/text/serializer/types/table.ts#L531)
...
[client/internal/text/serializer/types/table.ts:525](https://github.com/onzag/itemize/blob/59702dd5/client/internal/text/serializer/types/table.ts#L525)
