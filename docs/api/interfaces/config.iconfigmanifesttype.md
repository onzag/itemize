[](../README.md) / [Exports](../modules.md) / [config](../modules/config.md) / IConfigManifestType
...
Defined in: [config.ts:26](https://github.com/onzag/itemize/blob/3efa2a4a/config.ts#L26)
...
Defined in: [config.ts:34](https://github.com/onzag/itemize/blob/3efa2a4a/config.ts#L34)
...
Defined in: [config.ts:14](https://github.com/onzag/itemize/blob/3efa2a4a/config.ts#L14)
...
Defined in: [config.ts:18](https://github.com/onzag/itemize/blob/3efa2a4a/config.ts#L18)
...
Defined in: [config.ts:30](https://github.com/onzag/itemize/blob/3efa2a4a/config.ts#L30)
...
Defined in: [config.ts:22](https://github.com/onzag/itemize/blob/3efa2a4a/config.ts#L22)
