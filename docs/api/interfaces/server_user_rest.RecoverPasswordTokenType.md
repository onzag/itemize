[@onzag/itemize](../README.md) / [Modules](../modules.md) / [server/user/rest](../modules/server_user_rest.md) / RecoverPasswordTokenType
...
[server/user/rest.ts:29](https://github.com/onzag/itemize/blob/73e0c39e/server/user/rest.ts#L29)
...
[server/user/rest.ts:28](https://github.com/onzag/itemize/blob/73e0c39e/server/user/rest.ts#L28)
