[@onzag/itemize](../README.md) / [Modules](../modules.md) / [client/internal/text/serializer/types/table-element](../modules/client_internal_text_serializer_types_table_element.md) / ITableElement

# Interface: ITableElement

[client/internal/text/serializer/types/table-element](../modules/client_internal_text_serializer_types_table_element.md).ITableElement
...
- [blur](client_internal_text_serializer_types_table_element.ITableElement.md#blur)
- [children](client_internal_text_serializer_types_table_element.ITableElement.md#children)
- [click](client_internal_text_serializer_types_table_element.ITableElement.md#click)
- [containment](client_internal_text_serializer_types_table_element.ITableElement.md#containment)
- [context](client_internal_text_serializer_types_table_element.ITableElement.md#context)
- [focus](client_internal_text_serializer_types_table_element.ITableElement.md#focus)
- [forEach](client_internal_text_serializer_types_table_element.ITableElement.md#foreach)
- [givenName](client_internal_text_serializer_types_table_element.ITableElement.md#givenname)
- [html](client_internal_text_serializer_types_table_element.ITableElement.md#html)
- [ifCondition](client_internal_text_serializer_types_table_element.ITableElement.md#ifcondition)
- [input](client_internal_text_serializer_types_table_element.ITableElement.md#input)
- [keydown](client_internal_text_serializer_types_table_element.ITableElement.md#keydown)
- [keypress](client_internal_text_serializer_types_table_element.ITableElement.md#keypress)
- [keyup](client_internal_text_serializer_types_table_element.ITableElement.md#keyup)
- [mousedown](client_internal_text_serializer_types_table_element.ITableElement.md#mousedown)
- [mouseenter](client_internal_text_serializer_types_table_element.ITableElement.md#mouseenter)
- [mouseleave](client_internal_text_serializer_types_table_element.ITableElement.md#mouseleave)
- [mousemove](client_internal_text_serializer_types_table_element.ITableElement.md#mousemove)
- [mouseout](client_internal_text_serializer_types_table_element.ITableElement.md#mouseout)
- [mouseover](client_internal_text_serializer_types_table_element.ITableElement.md#mouseover)
- [mouseup](client_internal_text_serializer_types_table_element.ITableElement.md#mouseup)
- [mousewheel](client_internal_text_serializer_types_table_element.ITableElement.md#mousewheel)
- [richClassList](client_internal_text_serializer_types_table_element.ITableElement.md#richclasslist)
- [style](client_internal_text_serializer_types_table_element.ITableElement.md#style)
- [styleActive](client_internal_text_serializer_types_table_element.ITableElement.md#styleactive)
- [styleHover](client_internal_text_serializer_types_table_element.ITableElement.md#stylehover)
- [tableElementType](client_internal_text_serializer_types_table_element.ITableElement.md#tableelementtype)
- [textContent](client_internal_text_serializer_types_table_element.ITableElement.md#textcontent)
- [touchcancel](client_internal_text_serializer_types_table_element.ITableElement.md#touchcancel)
- [touchend](client_internal_text_serializer_types_table_element.ITableElement.md#touchend)
- [touchmove](client_internal_text_serializer_types_table_element.ITableElement.md#touchmove)
- [touchstart](client_internal_text_serializer_types_table_element.ITableElement.md#touchstart)
- [type](client_internal_text_serializer_types_table_element.ITableElement.md#type)
- [uiHandler](client_internal_text_serializer_types_table_element.ITableElement.md#uihandler)
- [uiHandlerArgs](client_internal_text_serializer_types_table_element.ITableElement.md#uihandlerargs)
- [wheel](client_internal_text_serializer_types_table_element.ITableElement.md#wheel)
...
• **children**: ([`RichElement`](../modules/client_internal_text_serializer.md#richelement) \| [`IText`](client_internal_text_serializer_types_text.IText.md))[]
...
[client/internal/text/serializer/types/table-element.ts:182](https://github.com/onzag/itemize/blob/5c2808d3/client/internal/text/serializer/types/table-element.ts#L182)
...
[client/internal/text/serializer/types/table-element.ts:172](https://github.com/onzag/itemize/blob/5c2808d3/client/internal/text/serializer/types/table-element.ts#L172)
...
• **tableElementType**: ``"table"`` \| ``"tbody"`` \| ``"thead"`` \| ``"tr"`` \| ``"td"``

A container type, might be null

#### Defined in

[client/internal/text/serializer/types/table-element.ts:176](https://github.com/onzag/itemize/blob/5c2808d3/client/internal/text/serializer/types/table-element.ts#L176)
...
[client/internal/text/serializer/types/table-element.ts:168](https://github.com/onzag/itemize/blob/5c2808d3/client/internal/text/serializer/types/table-element.ts#L168)
