...
Defined in: [config.ts:322](https://github.com/onzag/itemize/blob/5fcde7cf/config.ts#L322)
...
Defined in: [config.ts:312](https://github.com/onzag/itemize/blob/5fcde7cf/config.ts#L312)
...
Defined in: [config.ts:317](https://github.com/onzag/itemize/blob/5fcde7cf/config.ts#L317)
