...
Defined in: [config.ts:178](https://github.com/onzag/itemize/blob/0e9b128c/config.ts#L178)
...
Defined in: [config.ts:173](https://github.com/onzag/itemize/blob/0e9b128c/config.ts#L173)
