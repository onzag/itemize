[@onzag/itemize](../README.md) / [Modules](../modules.md) / [client/internal/text/serializer/types/table](../modules/client_internal_text_serializer_types_table.md) / ITr

# Interface: ITr

[client/internal/text/serializer/types/table](../modules/client_internal_text_serializer_types_table.md).ITr
...
- [blur](client_internal_text_serializer_types_table.ITr.md#blur)
- [children](client_internal_text_serializer_types_table.ITr.md#children)
- [click](client_internal_text_serializer_types_table.ITr.md#click)
- [context](client_internal_text_serializer_types_table.ITr.md#context)
- [focus](client_internal_text_serializer_types_table.ITr.md#focus)
- [forEach](client_internal_text_serializer_types_table.ITr.md#foreach)
- [givenName](client_internal_text_serializer_types_table.ITr.md#givenname)
- [html](client_internal_text_serializer_types_table.ITr.md#html)
- [ifCondition](client_internal_text_serializer_types_table.ITr.md#ifcondition)
- [input](client_internal_text_serializer_types_table.ITr.md#input)
- [keydown](client_internal_text_serializer_types_table.ITr.md#keydown)
- [keypress](client_internal_text_serializer_types_table.ITr.md#keypress)
- [keyup](client_internal_text_serializer_types_table.ITr.md#keyup)
- [mousedown](client_internal_text_serializer_types_table.ITr.md#mousedown)
- [mouseenter](client_internal_text_serializer_types_table.ITr.md#mouseenter)
- [mouseleave](client_internal_text_serializer_types_table.ITr.md#mouseleave)
- [mousemove](client_internal_text_serializer_types_table.ITr.md#mousemove)
- [mouseout](client_internal_text_serializer_types_table.ITr.md#mouseout)
- [mouseover](client_internal_text_serializer_types_table.ITr.md#mouseover)
- [mouseup](client_internal_text_serializer_types_table.ITr.md#mouseup)
- [mousewheel](client_internal_text_serializer_types_table.ITr.md#mousewheel)
- [richClassList](client_internal_text_serializer_types_table.ITr.md#richclasslist)
- [style](client_internal_text_serializer_types_table.ITr.md#style)
- [styleActive](client_internal_text_serializer_types_table.ITr.md#styleactive)
- [styleHover](client_internal_text_serializer_types_table.ITr.md#stylehover)
- [textContent](client_internal_text_serializer_types_table.ITr.md#textcontent)
- [touchcancel](client_internal_text_serializer_types_table.ITr.md#touchcancel)
- [touchend](client_internal_text_serializer_types_table.ITr.md#touchend)
- [touchmove](client_internal_text_serializer_types_table.ITr.md#touchmove)
- [touchstart](client_internal_text_serializer_types_table.ITr.md#touchstart)
- [type](client_internal_text_serializer_types_table.ITr.md#type)
- [uiHandler](client_internal_text_serializer_types_table.ITr.md#uihandler)
- [uiHandlerArgs](client_internal_text_serializer_types_table.ITr.md#uihandlerargs)
- [wheel](client_internal_text_serializer_types_table.ITr.md#wheel)
...
• **children**: ([`ITd`](client_internal_text_serializer_types_table.ITd.md) \| [`ITh`](client_internal_text_serializer_types_table.ITh.md))[]
...
[client/internal/text/serializer/types/table.ts:503](https://github.com/onzag/itemize/blob/59702dd5/client/internal/text/serializer/types/table.ts#L503)
...
[client/internal/text/serializer/types/table.ts:497](https://github.com/onzag/itemize/blob/59702dd5/client/internal/text/serializer/types/table.ts#L497)
