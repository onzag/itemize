...
[client/components/user/UserActioner.tsx:93](https://github.com/onzag/itemize/blob/5c2808d3/client/components/user/UserActioner.tsx#L93)
...
[client/components/user/UserActioner.tsx:79](https://github.com/onzag/itemize/blob/5c2808d3/client/components/user/UserActioner.tsx#L79)
...
[client/components/user/UserActioner.tsx:84](https://github.com/onzag/itemize/blob/5c2808d3/client/components/user/UserActioner.tsx#L84)

## Methods

### cleanUnsafeFields

▸ **cleanUnsafeFields**(`addDelay?`): `void`
...
[client/components/user/UserActioner.tsx:103](https://github.com/onzag/itemize/blob/5c2808d3/client/components/user/UserActioner.tsx#L103)
...
[client/components/user/UserActioner.tsx:97](https://github.com/onzag/itemize/blob/5c2808d3/client/components/user/UserActioner.tsx#L97)
...
[client/components/user/UserActioner.tsx:88](https://github.com/onzag/itemize/blob/5c2808d3/client/components/user/UserActioner.tsx#L88)

___

### resetPasswordWithEmailReceivedRandomId

▸ **resetPasswordWithEmailReceivedRandomId**(`randomId`, `email`, `cleanWhenSuccessful?`): `Promise`<{ `error`: [`EndpointErrorType`](../modules/base_errors.md#endpointerrortype)  }\>
...
[client/components/user/UserActioner.tsx:66](https://github.com/onzag/itemize/blob/5c2808d3/client/components/user/UserActioner.tsx#L66)

___

### resetPasswordWithSMSReceivedRandomId

▸ **resetPasswordWithSMSReceivedRandomId**(`randomId`, `phone`, `cleanWhenSuccessful?`): `Promise`<{ `error`: [`EndpointErrorType`](../modules/base_errors.md#endpointerrortype)  }\>
...
[client/components/user/UserActioner.tsx:73](https://github.com/onzag/itemize/blob/5c2808d3/client/components/user/UserActioner.tsx#L73)

___

### resetPasswordWithToken

▸ **resetPasswordWithToken**(`token`, `cleanWhenSuccessful?`): `Promise`<{ `error`: [`EndpointErrorType`](../modules/base_errors.md#endpointerrortype)  }\>
...
[client/components/user/UserActioner.tsx:59](https://github.com/onzag/itemize/blob/5c2808d3/client/components/user/UserActioner.tsx#L59)
...
[client/components/user/UserActioner.tsx:45](https://github.com/onzag/itemize/blob/5c2808d3/client/components/user/UserActioner.tsx#L45)
...
[client/components/user/UserActioner.tsx:51](https://github.com/onzag/itemize/blob/5c2808d3/client/components/user/UserActioner.tsx#L51)
...
[client/components/user/UserActioner.tsx:27](https://github.com/onzag/itemize/blob/5c2808d3/client/components/user/UserActioner.tsx#L27)
...
[client/components/user/UserActioner.tsx:31](https://github.com/onzag/itemize/blob/5c2808d3/client/components/user/UserActioner.tsx#L31)

___

### validateEmailFromRandomId

▸ **validateEmailFromRandomId**(`randomId`): `Promise`<{ `error`: [`EndpointErrorType`](../modules/base_errors.md#endpointerrortype)  }\>
...
[client/components/user/UserActioner.tsx:39](https://github.com/onzag/itemize/blob/5c2808d3/client/components/user/UserActioner.tsx#L39)

___

### validatePhoneFromRandomId

▸ **validatePhoneFromRandomId**(`randomId`): `Promise`<{ `error`: [`EndpointErrorType`](../modules/base_errors.md#endpointerrortype)  }\>
...
[client/components/user/UserActioner.tsx:35](https://github.com/onzag/itemize/blob/5c2808d3/client/components/user/UserActioner.tsx#L35)
