...
Defined in: [client/components/user/UserActioner.tsx:71](https://github.com/onzag/itemize/blob/0569bdf2/client/components/user/UserActioner.tsx#L71)
...
Defined in: [client/components/user/UserActioner.tsx:65](https://github.com/onzag/itemize/blob/0569bdf2/client/components/user/UserActioner.tsx#L65)
...
Defined in: [client/components/user/UserActioner.tsx:56](https://github.com/onzag/itemize/blob/0569bdf2/client/components/user/UserActioner.tsx#L56)
...
• **resetPassword**: (`token`: *string*, `cleanWhenSuccessful?`: *boolean*) => *Promise*<{ `error`: [*EndpointErrorType*](../modules/errors.md#endpointerrortype)  }\>
...
▸ (`token`: *string*, `cleanWhenSuccessful?`: *boolean*): *Promise*<{ `error`: [*EndpointErrorType*](../modules/errors.md#endpointerrortype)  }\>
...
**Returns:** *Promise*<{ `error`: [*EndpointErrorType*](../modules/errors.md#endpointerrortype)  }\>

Defined in: [client/components/user/UserActioner.tsx:41](https://github.com/onzag/itemize/blob/0569bdf2/client/components/user/UserActioner.tsx#L41)
...
• **sendResetPassword**: () => *Promise*<{ `error`: [*EndpointErrorType*](../modules/errors.md#endpointerrortype)  }\>
...
▸ (): *Promise*<{ `error`: [*EndpointErrorType*](../modules/errors.md#endpointerrortype)  }\>

**Returns:** *Promise*<{ `error`: [*EndpointErrorType*](../modules/errors.md#endpointerrortype)  }\>

Defined in: [client/components/user/UserActioner.tsx:33](https://github.com/onzag/itemize/blob/0569bdf2/client/components/user/UserActioner.tsx#L33)
...
• **sendValidateEmail**: () => *Promise*<{ `error`: [*EndpointErrorType*](../modules/errors.md#endpointerrortype)  }\>
...
Defined in: [client/components/user/UserActioner.tsx:27](https://github.com/onzag/itemize/blob/0569bdf2/client/components/user/UserActioner.tsx#L27)
...
• **statefulError**: [*EndpointErrorType*](../modules/errors.md#endpointerrortype)
...
Defined in: [client/components/user/UserActioner.tsx:61](https://github.com/onzag/itemize/blob/0569bdf2/client/components/user/UserActioner.tsx#L61)
...
Defined in: [client/components/user/UserActioner.tsx:47](https://github.com/onzag/itemize/blob/0569bdf2/client/components/user/UserActioner.tsx#L47)
...
Defined in: [client/components/user/UserActioner.tsx:52](https://github.com/onzag/itemize/blob/0569bdf2/client/components/user/UserActioner.tsx#L52)
