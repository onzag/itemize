...
Defined in: [server/services/fake-mail.ts:8](https://github.com/onzag/itemize/blob/11a98dec/server/services/fake-mail.ts#L8)
...
Defined in: [server/services/fake-mail.ts:5](https://github.com/onzag/itemize/blob/11a98dec/server/services/fake-mail.ts#L5)
