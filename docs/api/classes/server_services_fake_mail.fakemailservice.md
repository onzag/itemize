...
Defined in: [server/services/fake-mail.ts:8](https://github.com/onzag/itemize/blob/0e9b128c/server/services/fake-mail.ts#L8)
...
Defined in: [server/services/fake-mail.ts:5](https://github.com/onzag/itemize/blob/0e9b128c/server/services/fake-mail.ts#L5)
