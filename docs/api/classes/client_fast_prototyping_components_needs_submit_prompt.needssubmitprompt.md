...
Defined in: [client/fast-prototyping/components/needs-submit-prompt.tsx:132](https://github.com/onzag/itemize/blob/11a98dec/client/fast-prototyping/components/needs-submit-prompt.tsx#L132)
