...
• **new NeedsSubmitPrompt**(`props`, `context`)
...
[client/fast-prototyping/components/needs-submit-prompt.tsx:132](https://github.com/onzag/itemize/blob/f2f29986/client/fast-prototyping/components/needs-submit-prompt.tsx#L132)
