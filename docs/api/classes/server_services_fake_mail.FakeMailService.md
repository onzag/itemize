...
• **new FakeMailService**(`config`, `registry`, `appConfig`, `appSensitiveConfig`)
...
[server/services/fake-mail.ts:8](https://github.com/onzag/itemize/blob/f2f29986/server/services/fake-mail.ts#L8)
...
[server/services/fake-mail.ts:5](https://github.com/onzag/itemize/blob/f2f29986/server/services/fake-mail.ts#L5)
