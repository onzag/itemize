...
• **new FakeSMSService**(`c`, `registry`, `configs`)
...
[server/services/fake-sms.ts:8](https://github.com/onzag/itemize/blob/a24376ed/server/services/fake-sms.ts#L8)
...
[server/services/fake-sms.ts:5](https://github.com/onzag/itemize/blob/a24376ed/server/services/fake-sms.ts#L5)
