[@onzag/itemize](../README.md) / [Modules](../modules.md) / [client/internal/providers/appdata-provider](../modules/client_internal_providers_appdata_provider.md) / DataProvider
...
• **new DataProvider**(`props`): [`DataProvider`](client_internal_providers_appdata_provider.DataProvider.md)
...
[`DataProvider`](client_internal_providers_appdata_provider.DataProvider.md)

#### Inherited from

React.Component\<IDataProviderProps\>.constructor

#### Defined in

node_modules/@types/react/index.d.ts:475

• **new DataProvider**(`props`, `context`): [`DataProvider`](client_internal_providers_appdata_provider.DataProvider.md)
...
[client/internal/providers/appdata-provider.tsx:56](https://github.com/onzag/itemize/blob/59702dd5/client/internal/providers/appdata-provider.tsx#L56)
...
[client/internal/providers/appdata-provider.tsx:50](https://github.com/onzag/itemize/blob/59702dd5/client/internal/providers/appdata-provider.tsx#L50)
