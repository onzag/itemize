...
- [appDbConfig](server_services_base_UserLocalizationProvider.default.md#appdbconfig)
- [appRedisConfig](server_services_base_UserLocalizationProvider.default.md#appredisconfig)
...
- [expressRouter](server_services_base_UserLocalizationProvider.default.md#expressrouter-1)
- [getRouter](server_services_base_UserLocalizationProvider.default.md#getrouter-1)
- [getTriggerRegistry](server_services_base_UserLocalizationProvider.default.md#gettriggerregistry-1)
- [getType](server_services_base_UserLocalizationProvider.default.md#gettype)
- [logDebug](server_services_base_UserLocalizationProvider.default.md#logdebug-1)
- [logError](server_services_base_UserLocalizationProvider.default.md#logerror-1)
- [logInfo](server_services_base_UserLocalizationProvider.default.md#loginfo-1)

## Constructors

### constructor

• **new default**\<`T`\>(`config`, `registry`, `configs`): [`default`](server_services_base_UserLocalizationProvider.default.md)\<`T`\>
...
[`default`](server_services_base_UserLocalizationProvider.default.md)\<`T`\>
...
[server/services/base/UserLocalizationProvider.ts:19](https://github.com/onzag/itemize/blob/59702dd5/server/services/base/UserLocalizationProvider.ts#L19)
...
[server/services/base/UserLocalizationProvider.ts:10](https://github.com/onzag/itemize/blob/59702dd5/server/services/base/UserLocalizationProvider.ts#L10)
