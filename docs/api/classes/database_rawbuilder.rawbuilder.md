...
Defined in: [database/RawBuilder.ts:18](https://github.com/onzag/itemize/blob/3efa2a4a/database/RawBuilder.ts#L18)
...
Defined in: [database/RawBuilder.ts:39](https://github.com/onzag/itemize/blob/3efa2a4a/database/RawBuilder.ts#L39)
