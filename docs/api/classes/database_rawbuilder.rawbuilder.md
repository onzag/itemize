...
Defined in: [database/RawBuilder.ts:18](https://github.com/onzag/itemize/blob/11a98dec/database/RawBuilder.ts#L18)
...
Defined in: [database/RawBuilder.ts:39](https://github.com/onzag/itemize/blob/11a98dec/database/RawBuilder.ts#L39)
