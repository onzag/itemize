...
• **new StripeService**(`config`, `registry`, `configs`)
...
[server/services/stripe.ts:32](https://github.com/onzag/itemize/blob/f2db74a5/server/services/stripe.ts#L32)
...
[server/services/stripe.ts:38](https://github.com/onzag/itemize/blob/f2db74a5/server/services/stripe.ts#L38)
...
[server/services/stripe.ts:33](https://github.com/onzag/itemize/blob/f2db74a5/server/services/stripe.ts#L33)
