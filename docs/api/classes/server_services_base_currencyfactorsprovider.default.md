...
Defined in: [server/services/base/CurrencyFactorsProvider.ts:50](https://github.com/onzag/itemize/blob/3efa2a4a/server/services/base/CurrencyFactorsProvider.ts#L50)
...
Defined in: [server/services/base/CurrencyFactorsProvider.ts:39](https://github.com/onzag/itemize/blob/3efa2a4a/server/services/base/CurrencyFactorsProvider.ts#L39)
