...
Defined in: [server/services/ipstack.ts:107](https://github.com/onzag/itemize/blob/3efa2a4a/server/services/ipstack.ts#L107)
...
Defined in: [server/services/ipstack.ts:45](https://github.com/onzag/itemize/blob/3efa2a4a/server/services/ipstack.ts#L45)
...
Defined in: [server/services/ipstack.ts:42](https://github.com/onzag/itemize/blob/3efa2a4a/server/services/ipstack.ts#L42)
