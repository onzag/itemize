[](../README.md) / [Exports](../modules.md) / [Root](../modules/root.md) / default

# Class: default

[Root](../modules/root.md).default
...
- [constructor](root.default.md#constructor)

### Properties

- [childModules](root.default.md#childmodules)
- [rawData](root.default.md#rawdata)
- [registry](root.default.md#registry)
- [requestManager](root.default.md#requestmanager)
- [rootState](root.default.md#rootstate)
- [serverFlags](root.default.md#serverflags)

### Methods

- [callRequestManager](root.default.md#callrequestmanager)
- [cleanState](root.default.md#cleanstate)
- [getAllModules](root.default.md#getallmodules)
- [getI18nData](root.default.md#geti18ndata)
- [getI18nDataFor](root.default.md#geti18ndatafor)
- [getModuleFor](root.default.md#getmodulefor)
- [getServerFlags](root.default.md#getserverflags)
- [getStateKey](root.default.md#getstatekey)
- [listModuleNames](root.default.md#listmodulenames)
- [mergeWithI18n](root.default.md#mergewithi18n)
- [setRequestManager](root.default.md#setrequestmanager)
- [setServerFlags](root.default.md#setserverflags)
- [setStateKey](root.default.md#setstatekey)
- [getModuleRawFor](root.default.md#getmodulerawfor)

## Constructors

### constructor

\+ **new default**(`rawJSON`: [*IRootRawJSONDataType*](../interfaces/root.irootrawjsondatatype.md)): [*default*](root.default.md)
...
:------ | :------ | :------ |
`rawJSON` | [*IRootRawJSONDataType*](../interfaces/root.irootrawjsondatatype.md) | the raw json data    |

**Returns:** [*default*](root.default.md)

Defined in: [base/Root/index.ts:216](https://github.com/onzag/itemize/blob/0569bdf2/base/Root/index.ts#L216)
...
Defined in: [base/Root/index.ts:193](https://github.com/onzag/itemize/blob/0569bdf2/base/Root/index.ts#L193)

___

### rawData

• **rawData**: [*IRootRawJSONDataType*](../interfaces/root.irootrawjsondatatype.md)

The raw data this root was generated from

**`internal`** 

Defined in: [base/Root/index.ts:162](https://github.com/onzag/itemize/blob/0569bdf2/base/Root/index.ts#L162)
...
Defined in: [base/Root/index.ts:185](https://github.com/onzag/itemize/blob/0569bdf2/base/Root/index.ts#L185)
...
Defined in: [base/Root/index.ts:208](https://github.com/onzag/itemize/blob/0569bdf2/base/Root/index.ts#L208)
...
Defined in: [base/Root/index.ts:200](https://github.com/onzag/itemize/blob/0569bdf2/base/Root/index.ts#L200)
...
Defined in: [base/Root/index.ts:290](https://github.com/onzag/itemize/blob/0569bdf2/base/Root/index.ts#L290)
...
Defined in: [base/Root/index.ts:240](https://github.com/onzag/itemize/blob/0569bdf2/base/Root/index.ts#L240)
...
Defined in: [base/Root/index.ts:325](https://github.com/onzag/itemize/blob/0569bdf2/base/Root/index.ts#L325)

___

### getI18nData

▸ **getI18nData**(): [*Ii18NType*](../interfaces/root.ii18ntype.md)
...
**Returns:** [*Ii18NType*](../interfaces/root.ii18ntype.md)

the whole i18n data object

Defined in: [base/Root/index.ts:424](https://github.com/onzag/itemize/blob/0569bdf2/base/Root/index.ts#L424)
...
locale, this is similar to [getI18nData](root.default.md#geti18ndata) in usability and
what it does
...
Defined in: [base/Root/index.ts:449](https://github.com/onzag/itemize/blob/0569bdf2/base/Root/index.ts#L449)
...
If you need modules you should use the [registry](root.default.md#registry) instead
...
Defined in: [base/Root/index.ts:356](https://github.com/onzag/itemize/blob/0569bdf2/base/Root/index.ts#L356)
...
Defined in: [base/Root/index.ts:476](https://github.com/onzag/itemize/blob/0569bdf2/base/Root/index.ts#L476)
...
Defined in: [base/Root/index.ts:266](https://github.com/onzag/itemize/blob/0569bdf2/base/Root/index.ts#L266)
...
Defined in: [base/Root/index.ts:306](https://github.com/onzag/itemize/blob/0569bdf2/base/Root/index.ts#L306)

___

### mergeWithI18n

▸ **mergeWithI18n**(`root`: [*IRootRawJSONDataType*](../interfaces/root.irootrawjsondatatype.md)): *void*
...
Name | Type | Description |
:------ | :------ | :------ |
`root` | [*IRootRawJSONDataType*](../interfaces/root.irootrawjsondatatype.md) | the other root in raw form   |

**Returns:** *void*

Defined in: [base/Root/index.ts:388](https://github.com/onzag/itemize/blob/0569bdf2/base/Root/index.ts#L388)
...
Defined in: [base/Root/index.ts:277](https://github.com/onzag/itemize/blob/0569bdf2/base/Root/index.ts#L277)
...
Defined in: [base/Root/index.ts:463](https://github.com/onzag/itemize/blob/0569bdf2/base/Root/index.ts#L463)
...
Defined in: [base/Root/index.ts:255](https://github.com/onzag/itemize/blob/0569bdf2/base/Root/index.ts#L255)

___

### getModuleRawFor

▸ `Static`**getModuleRawFor**(`root`: [*IRootRawJSONDataType*](../interfaces/root.irootrawjsondatatype.md), `name`: *string*[]): [*IModuleRawJSONDataType*](../interfaces/base_root_module.imodulerawjsondatatype.md)
...
Name | Type | Description |
:------ | :------ | :------ |
`root` | [*IRootRawJSONDataType*](../interfaces/root.irootrawjsondatatype.md) | the raw json root   |
`name` | *string*[] | the path of the module   |
...
Defined in: [base/Root/index.ts:122](https://github.com/onzag/itemize/blob/0569bdf2/base/Root/index.ts#L122)
