...
• **new TwilioService**(`config`, `registry`, `configs`)
...
[server/services/twilio.ts:8](https://github.com/onzag/itemize/blob/f2db74a5/server/services/twilio.ts#L8)
...
[server/services/twilio.ts:5](https://github.com/onzag/itemize/blob/f2db74a5/server/services/twilio.ts#L5)
