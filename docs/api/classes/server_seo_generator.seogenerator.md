...
\+ **new SEOGenerator**(`rules`: [*ISEORuleSet*](../interfaces/server_seo.iseoruleset.md), `storageClient`: [*default*](server_services_base_storageprovider.default.md)<any\>, `rawDB`: [*ItemizeRawDB*](server_raw_db.itemizerawdb.md), `root`: [*default*](root.default.md), `supportedLanguages`: *string*[], `hostname`: *string*, `pingGoogle`: *boolean*): [*SEOGenerator*](server_seo_generator.seogenerator.md)
...
`root` | [*default*](root.default.md) | the root for definitions   |
...
Defined in: [server/seo/generator.ts:77](https://github.com/onzag/itemize/blob/0569bdf2/server/seo/generator.ts#L77)
...
Defined in: [server/seo/generator.ts:72](https://github.com/onzag/itemize/blob/0569bdf2/server/seo/generator.ts#L72)
...
Defined in: [server/seo/generator.ts:76](https://github.com/onzag/itemize/blob/0569bdf2/server/seo/generator.ts#L76)
...
Defined in: [server/seo/generator.ts:73](https://github.com/onzag/itemize/blob/0569bdf2/server/seo/generator.ts#L73)
...
Defined in: [server/seo/generator.ts:75](https://github.com/onzag/itemize/blob/0569bdf2/server/seo/generator.ts#L75)
...
Defined in: [server/seo/generator.ts:68](https://github.com/onzag/itemize/blob/0569bdf2/server/seo/generator.ts#L68)
...
Defined in: [server/seo/generator.ts:67](https://github.com/onzag/itemize/blob/0569bdf2/server/seo/generator.ts#L67)
...
Defined in: [server/seo/generator.ts:70](https://github.com/onzag/itemize/blob/0569bdf2/server/seo/generator.ts#L70)
...
Defined in: [server/seo/generator.ts:69](https://github.com/onzag/itemize/blob/0569bdf2/server/seo/generator.ts#L69)
...
Defined in: [server/seo/generator.ts:71](https://github.com/onzag/itemize/blob/0569bdf2/server/seo/generator.ts#L71)
...
Defined in: [server/seo/generator.ts:320](https://github.com/onzag/itemize/blob/0569bdf2/server/seo/generator.ts#L320)
...
Defined in: [server/seo/generator.ts:359](https://github.com/onzag/itemize/blob/0569bdf2/server/seo/generator.ts#L359)
...
Defined in: [server/seo/generator.ts:598](https://github.com/onzag/itemize/blob/0569bdf2/server/seo/generator.ts#L598)
...
Defined in: [server/seo/generator.ts:120](https://github.com/onzag/itemize/blob/0569bdf2/server/seo/generator.ts#L120)
...
Defined in: [server/seo/generator.ts:444](https://github.com/onzag/itemize/blob/0569bdf2/server/seo/generator.ts#L444)
...
Defined in: [server/seo/generator.ts:329](https://github.com/onzag/itemize/blob/0569bdf2/server/seo/generator.ts#L329)
...
Defined in: [server/seo/generator.ts:348](https://github.com/onzag/itemize/blob/0569bdf2/server/seo/generator.ts#L348)
