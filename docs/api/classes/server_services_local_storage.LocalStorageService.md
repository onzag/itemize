...
• **new LocalStorageService**(`config`, `registry`, `configs`)
...
[server/services/local-storage.ts:103](https://github.com/onzag/itemize/blob/f2db74a5/server/services/local-storage.ts#L103)
...
[server/services/local-storage.ts:40](https://github.com/onzag/itemize/blob/f2db74a5/server/services/local-storage.ts#L40)
...
[server/services/local-storage.ts:99](https://github.com/onzag/itemize/blob/f2db74a5/server/services/local-storage.ts#L99)
...
[server/services/local-storage.ts:112](https://github.com/onzag/itemize/blob/f2db74a5/server/services/local-storage.ts#L112)
...
[server/services/local-storage.ts:135](https://github.com/onzag/itemize/blob/f2db74a5/server/services/local-storage.ts#L135)
...
[server/services/local-storage.ts:70](https://github.com/onzag/itemize/blob/f2db74a5/server/services/local-storage.ts#L70)
...
[server/services/local-storage.ts:45](https://github.com/onzag/itemize/blob/f2db74a5/server/services/local-storage.ts#L45)
...
[server/services/local-storage.ts:36](https://github.com/onzag/itemize/blob/f2db74a5/server/services/local-storage.ts#L36)
