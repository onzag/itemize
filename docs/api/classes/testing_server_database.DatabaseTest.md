...
• **new DatabaseTest**(`databaseConnection`, `testingInfo`)
...
[testing/server/database.ts:59](https://github.com/onzag/itemize/blob/f2db74a5/testing/server/database.ts#L59)
...
[testing/server/database.ts:57](https://github.com/onzag/itemize/blob/f2db74a5/testing/server/database.ts#L57)
...
[testing/server/database.ts:56](https://github.com/onzag/itemize/blob/f2db74a5/testing/server/database.ts#L56)
...
[testing/server/database.ts:55](https://github.com/onzag/itemize/blob/f2db74a5/testing/server/database.ts#L55)
...
[testing/server/database.ts:65](https://github.com/onzag/itemize/blob/f2db74a5/testing/server/database.ts#L65)
...
[testing/server/database.ts:71](https://github.com/onzag/itemize/blob/f2db74a5/testing/server/database.ts#L71)
