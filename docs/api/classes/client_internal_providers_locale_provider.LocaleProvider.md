[@onzag/itemize](../README.md) / [Modules](../modules.md) / [client/internal/providers/locale-provider](../modules/client_internal_providers_locale_provider.md) / LocaleProvider
...
• **new LocaleProvider**(`props`): [`LocaleProvider`](client_internal_providers_locale_provider.LocaleProvider.md)
...
[`LocaleProvider`](client_internal_providers_locale_provider.LocaleProvider.md)

#### Inherited from

React.Component\<ILocaleProviderProps\>.constructor

#### Defined in

node_modules/@types/react/index.d.ts:475

• **new LocaleProvider**(`props`, `context`): [`LocaleProvider`](client_internal_providers_locale_provider.LocaleProvider.md)
...
[client/internal/providers/locale-provider.tsx:121](https://github.com/onzag/itemize/blob/59702dd5/client/internal/providers/locale-provider.tsx#L121)
...
[client/internal/providers/locale-provider.tsx:112](https://github.com/onzag/itemize/blob/59702dd5/client/internal/providers/locale-provider.tsx#L112)
