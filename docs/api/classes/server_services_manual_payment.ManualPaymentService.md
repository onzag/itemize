...
• **new ManualPaymentService**(`config`, `registry`, `appConfig`, `appSensitiveConfig`)
...
[server/services/manual-payment.ts:19](https://github.com/onzag/itemize/blob/f2f29986/server/services/manual-payment.ts#L19)
...
[server/services/manual-payment.ts:32](https://github.com/onzag/itemize/blob/f2f29986/server/services/manual-payment.ts#L32)
