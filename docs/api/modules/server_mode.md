...
Defined in: [server/mode.ts:17](https://github.com/onzag/itemize/blob/3efa2a4a/server/mode.ts#L17)
...
Defined in: [server/mode.ts:33](https://github.com/onzag/itemize/blob/3efa2a4a/server/mode.ts#L33)
