...
Defined in: [client/internal/workers/cache/cache.worker.search.ts:66](https://github.com/onzag/itemize/blob/55e63f2c/client/internal/workers/cache/cache.worker.search.ts#L66)
