...
Defined in: [client/components/user/UserDataRetriever.tsx:33](https://github.com/onzag/itemize/blob/3efa2a4a/client/components/user/UserDataRetriever.tsx#L33)
