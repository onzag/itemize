[](../README.md) / [Exports](../modules.md) / client/internal/text/serializer/types/list
...
Defined in: [client/internal/text/serializer/types/list.ts:20](https://github.com/onzag/itemize/blob/0e9b128c/client/internal/text/serializer/types/list.ts#L20)
