...
async function buildItemDefinition(
  ...
  if (actualEvaledFileData.searchEngineFallbackLang) {
    finalValue.searchEngineFallbackLang = actualEvaledFileData.searchEngineFallbackLang;
  }

  if (actualEvaledFileData.searchEngineLangUseVersion) {
    finalValue.searchEngineLangUseVersion = actualEvaledFileData.searchEngineLangUseVersion;
  }
  ...
  if (actualEvaledFileData.customIdRoleAccess) {
    finalValue.customIdRoleAccess = actualEvaledFileData.customIdRoleAccess;
  }
...
async function getI18nPropertyData(
  ...
  if (
    definition.searchInterface === PropertyDefinitionSearchInterfacesType.LOCATION_RADIUS &&
    !searchIsDisabled
  ) {
