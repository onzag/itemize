// https://github.com/mike-marcacci/fs-capacitor/blob/main/src/index.ts
// copied and pasted because it will not work with commonjs as published
// this will ensure it works with commonJS and it's one less dependency
// to avoid NodeJS nightmarighs dependency hell as proof that even something as mild
// as this will cause the whole codebase to crash anyway because of dependency hell
