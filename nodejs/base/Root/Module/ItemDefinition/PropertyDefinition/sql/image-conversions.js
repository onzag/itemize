...
exports.runImageConversions = void 0;
 ...
 */
async function runImageConversions(imageStream, filePath, fileName, fileMimeType, uploadsClient, domain, propDef) {
    ...
    if (fileMimeType === "image/svg+xml") {
        await file_management_1.sqlUploadPipeFile(uploadsClient, imageStream, domain, originalImageFilePath);
        return;
    }
