...
const typeValue = {
    ...
    sql: sql_1.getStandardSQLFnFor && sql_1.getStandardSQLFnFor("time"),
    ...
    localOrderBy: (arg) => {
        ...
        const dateA = (new Date("1970-01-01T" + arg.a)).getTime();
        const dateB = (new Date("1970-01-01T" + arg.b)).getTime();
    ...
    validate: (d) => {
        ...
        const dateForm = moment_1.default(d, constants_1.TIME_FORMAT);
        if (!dateForm.isValid() || dateForm.format(constants_1.TIME_FORMAT) !== d) {
            return PropertyDefinition_1.PropertyInvalidReason.INVALID_VALUE;
        }
        return null;
    },
