 ...
 */
export declare function processFileListFor(newValues: IGQLFile[], oldValues: IGQLFile[], transitoryId: string, itemDefinition: ItemDefinition, include: Include, propertyDefinition: PropertyDefinition): Promise<{
    url: string;
    name: string;
    type: string;
    id: string;
 ...
 */
export declare function processSingleFileFor(newValue: IGQLFile, oldValue: IGQLFile, transitoryId: string, itemDefinition: ItemDefinition, include: Include, propertyDefinition: PropertyDefinition): Promise<{
    url: string;
    name: string;
    type: string;
    id: string;
