    ...
    itemDefinition: {
        io: {
            "users/user": async (arg) => {
                ...
                // event
                if ((arg.action === triggers_1.IOTriggerActions.CREATE || arg.action === triggers_1.IOTriggerActions.EDIT) &&
                    arg.value &&
                    arg.update) {
                ...
                if (hasEmail &&
                    hasEvalidated &&
                    (arg.action === triggers_1.IOTriggerActions.CREATE || arg.action === triggers_1.IOTriggerActions.EDIT) &&
                    arg.update) {
