...
exports.ItemContext = react_1.default.createContext(null);
exports.SearchItemValueContext = react_1.default.createContext(null);
;
/**
 * Here it is, the mighty
 */
class ActualItemProvider extends react_1.default.Component {
    constructor(props) {
        super(props);
    ...
    static getDerivedStateFromProps(props, state) {
        ...
        if (props.itemDefinitionQualifiedName !== state.itemState.itemDefQualifiedName ||
            (props.forId || null) !== (state.itemState.forId || null)) {
            // note how we pass the optimization flags
            return {
                itemState: props.itemDefinitionInstance.getStateNoExternalChecking(props.forId || null, props.forVersion || null, !props.disableExternalChecks, props.itemDefinitionInstance.isInSearchMode() ?
    ...
    async componentDidUpdate(prevProps, prevState) {
        ...
        if (this.props.onStateChange && !deep_equal_1.default(this.state.itemState, prevState.itemState)) {
    ...
    async setStateToCurrentValueWithExternalChecking(currentUpdateId) {
        ...
        const newItemState = await this.props.itemDefinitionInstance.getState(this.props.forId || null, this.props.forVersion || null, this.props.itemDefinitionInstance.isInSearchMode() ?
            getPropertyListForSearchMode(this.props.properties || [], this.props.itemDefinitionInstance.getStandardCounterpart()) : this.props.properties || [], this.props.includes || [], !this.props.includePolicies);
    ...
    return (react_1.default.createElement(config_provider_1.ConfigContext.Consumer, null, (config) => (react_1.default.createElement(locale_provider_1.LocaleContext.Consumer, null, (localeData) => (react_1.default.createElement(token_provider_1.TokenContext.Consumer, null, (tokenData) => (react_1.default.createElement(module_1.ModuleContext.Consumer, null, (data) => (react_1.default.createElement(exports.SearchItemValueContext.Consumer, null, (searchContext) => {
        ...
        if (props.injectParentContext) {
            if (props.loadSearchFromNavigation) {
                return (react_1.default.createElement(LocationRetriever_1.default, null, (location) => (react_1.default.createElement(exports.ItemContext.Consumer, null, (value) => (react_1.default.createElement(ActualItemProvider, Object.assign({}, actualProps, { injectedParentContext: value, location: location })))))));
            }
            else {
                return (react_1.default.createElement(exports.ItemContext.Consumer, null, (value) => (react_1.default.createElement(ActualItemProvider, Object.assign({}, actualProps, { injectedParentContext: value })))));
            }
        }
        if (props.loadSearchFromNavigation) {
            return (react_1.default.createElement(LocationRetriever_1.default, null, (location) => (react_1.default.createElement(ActualItemProvider, Object.assign({}, actualProps, { injectedParentContext: null, location: location })))));
        }
        else {
            return (react_1.default.createElement(ActualItemProvider, Object.assign({}, actualProps, { injectedParentContext: null })));
        }
    }))))))))));
}
...
exports.ParentItemContextProvider = ParentItemContextProvider;
