...
exports.CurrentUserProfileStandardInfo = mui_core_1.withStyles(currentUserProfileStandardInfoStyles)((props) => {
    return (react_1.default.createElement(mui_core_1.Paper, { className: props.classes.paper },
        react_1.default.createElement(item_definition_loader_1.ItemDefinitionLoader, null,
            ...
            react_1.default.createElement(mui_core_1.Box, { className: props.classes.containerBox },
                react_1.default.createElement(I18nReadMany_1.default, { data: [
                    ...
                    react_1.default.createElement(Link_1.default, { to: "/preferences" },
                        react_1.default.createElement(Reader_1.default, { id: "address" }, (value, stateValue) => {
                            ...
                            return (react_1.default.createElement(mui_core_1.Button, { variant: "text", size: "small", fullWidth: true, className: props.classes.containerBoxButton, endIcon: hasWarning ? react_1.default.createElement(mui_core_1.ErrorIcon, { className: props.classes.errorIconButton }) : null }, i18nPreferences));
                        })),
                    react_1.default.createElement(Link_1.default, { to: "/change-password" },
                        react_1.default.createElement(mui_core_1.Button, { variant: "text", size: "small", fullWidth: true, className: props.classes.containerBoxButton }, i18nChangePassword)))))),
            react_1.default.createElement(Entry_1.default, { id: "username", icon: react_1.default.createElement(mui_core_1.AccountCircleIcon, null) }),
            react_1.default.createElement(Reader_1.default, { id: "email" }, (email, emailState) => {
                ...
                if (missesEmail) {
                    return (react_1.default.createElement(mui_core_1.Alert, { severity: "error" },
                        react_1.default.createElement(mui_core_1.AlertTitle, null,
            ...
            react_1.default.createElement(Entry_1.default, { id: "email", rendererArgs: { descriptionAsAlert: true }, icon: react_1.default.createElement(mui_core_1.AlernateEmailIcon, null) }),
            react_1.default.createElement(Entry_1.default, { id: "about_me", icon: react_1.default.createElement(mui_core_1.FaceIcon, null) }),
            ...
            react_1.default.createElement(mui_core_1.Box, { className: props.classes.buttonBox },
                react_1.default.createElement(DifferingPropertiesRetriever_1.default, { mainProperties: ["profile_picture", "username", "email", "about_me"] }, (differingProperties) => {
                    ...
                    return (react_1.default.createElement(buttons_1.SubmitButton, { i18nId: "update_profile", options: options, CustomConfirmationComponent: CustomConfirmationComponent, buttonColor: "primary", buttonStartIcon: react_1.default.createElement(mui_core_1.DoneOutlineIcon, null), buttonVariant: "contained" }));
                })))));
});
