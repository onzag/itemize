                    ...
                    react_1.default.createElement(mui_core_1.Container, { maxWidth: "md", className: props.classes.container },
                        react_1.default.createElement(mui_core_1.Paper, { className: props.classes.paper },
                            react_1.default.createElement(item_definition_loader_1.ItemDefinitionLoader, null,
                                react_1.default.createElement(avatar_1.Avatar, { size: "large", fullWidth: true, hideFlag: true }),
                                react_1.default.createElement(Reader_1.default, { id: "username" }, (username) => (react_1.default.createElement(mui_core_1.Typography, { variant: "h4", className: props.classes.username }, username)))),
                            react_1.default.createElement(mui_core_1.Divider, { className: props.classes.divider }),
                            react_1.default.createElement(mui_core_1.Typography, { variant: "h6", className: props.classes.recoverTitle }, i18nResetPassword),
