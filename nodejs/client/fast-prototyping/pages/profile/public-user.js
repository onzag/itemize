        ...
        react_1.default.createElement(mui_core_1.Container, { maxWidth: "md", className: props.classes.container },
            react_1.default.createElement(mui_core_1.Paper, { className: props.classes.paper },
                react_1.default.createElement(item_definition_loader_1.ItemDefinitionLoader, null,
                    ...
                    react_1.default.createElement(Reader_1.default, { id: "e_validated" }, (eValidated) => (react_1.default.createElement(Reader_1.default, { id: "username" }, (username) => (react_1.default.createElement(mui_core_1.Typography, { variant: "h4", className: props.classes.username },
                        username,
                        eValidated ? react_1.default.createElement("span", null,
                            react_1.default.createElement("span", { className: props.classes.spacer }),
                            react_1.default.createElement(I18nRead_1.default, { id: "label", propertyId: "e_validated", capitalize: true }, (i18nUserValidated) => (react_1.default.createElement(mui_core_1.Tooltip, { title: i18nUserValidated },
                                react_1.default.createElement(mui_core_1.VerifiedUserIcon, { className: props.classes.verifiedIcon }))))) : null)))))),
                react_1.default.createElement(Reader_1.default, { id: "app_country" }, (country) => {
                    ...
                    return react_1.default.createElement(mui_core_1.Typography, { variant: "h5", className: props.classes.country }, countryobj.emoji + " " + countryobj.native);
                }),
                react_1.default.createElement(Reader_1.default, { id: "role" }, (role) => {
                    if (role !== "USER") {
                        return react_1.default.createElement(mui_core_1.Typography, { variant: "h5", className: props.classes.role },
                ...
                react_1.default.createElement(mui_core_1.Card, { className: props.classes.aboutMeCard, variant: "outlined" },
