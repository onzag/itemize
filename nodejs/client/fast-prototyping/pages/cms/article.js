...
exports.Article = core_1.withStyles(fragmentStyles)((props) => {
    return (react_1.default.createElement(util_1.SlowLoadingElement, { id: "article" },
        react_1.default.createElement(LocationStateReader_1.default, { defaultState: { id: "" }, stateIsInQueryString: true }, (locationState, setState) => {
