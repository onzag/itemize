    ...
    return (react_1.default.createElement(mui_core_1.Container, { maxWidth: "md", className: props.classes.container },
        react_1.default.createElement(mui_core_1.Paper, { className: props.classes.paper },
            react_1.default.createElement(I18nReadMany_1.default, { data: [
                ...
                react_1.default.createElement(mui_core_1.Alert, { severity: "error" },
                    react_1.default.createElement(mui_core_1.AlertTitle, null, i18nGenericWarning),
                    i18nWarning),
                react_1.default.createElement(mui_core_1.Typography, { variant: "body1", className: props.classes.infoText }, i18nInfoContent1),
                react_1.default.createElement(mui_core_1.Typography, { variant: "body1", className: props.classes.infoText }, i18nInfoContent2)))))));
});
