...
function WeChatIcon(props) {
    return (react_1.default.createElement(SvgIcon_1.default, { viewBox: "-40 -40 380 380", className: props.className }, wechatsrc));
}
...
function VKIcon(props) {
    return (react_1.default.createElement(SvgIcon_1.default, { viewBox: "-93 -93 1210 1210", className: props.className }, vksrc));
}
