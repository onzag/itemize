...
declare const PropertyEntryTextRenderer: React.ComponentType<Pick<IPropertyEntryTextRendererWithStylesProps, "label" | "placeholder" | "description" | "rtl" | "args" | "onChange" | "onRestore" | "autoFocus" | "icon" | "currentAppliedValue" | "canRestore" | "currentValue" | "currentValid" | "currentInvalidReason" | "currentInternalValue" | "disabled" | "isRichText" | "supportsVideos" | "supportsImages" | "supportsFiles" | "lastLoadedFileError" | "i18nFormat" | "i18nLoadVideo" | "mediaPropertyAcceptsFiles" | "mediaPropertyAcceptsImages" | "i18nGenericError" | "i18nOk" | "dismissLastLoadedFileError" | "onInsertFile" | "onInsertImage"> & import("@material-ui/styles").StyledComponentProps<"entry" | "label" | "description" | "icon" | "toolbar" | "container" | "errorMessage" | "iconButton" | "textButton" | "labelSingleLine" | "labelNoToolbar" | "quill" | "rawTextArea"> & IPropertyEntryTextRendererProps>;
