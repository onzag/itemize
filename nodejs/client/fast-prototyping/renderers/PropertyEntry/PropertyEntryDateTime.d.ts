...
declare const PropertyEntryDateTimeRenderer: React.ComponentType<Pick<IPropertyEntryDateTimeRendererWithStylesProps, "label" | "type" | "placeholder" | "description" | "rtl" | "args" | "onChange" | "onRestore" | "autoFocus" | "icon" | "currentAppliedValue" | "canRestore" | "currentValue" | "currentValid" | "currentInvalidReason" | "currentInternalValue" | "disabled" | "momentValue" | "i18nOk" | "i18nCancel" | "onChangeByMoment"> & import("@material-ui/styles").StyledComponentProps<"entry" | "label" | "description" | "container" | "errorMessage" | "iconButton" | "fieldInput"> & IPropertyEntryDateTimeRendererProps>;
