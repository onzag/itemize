 ...
 */
declare const PropertyEntrySelectRenderer: React.ComponentType<Pick<IPropertyEntrySelectRendererWithStylesProps, "label" | "values" | "placeholder" | "description" | "rtl" | "args" | "onChange" | "onRestore" | "autoFocus" | "icon" | "propertyId" | "currentAppliedValue" | "canRestore" | "currentValue" | "currentValid" | "currentInvalidReason" | "currentInternalValue" | "disabled" | "isNullable" | "nullValue" | "isNumeric" | "currentI18nValue"> & import("@material-ui/styles").StyledComponentProps<"entry" | "label" | "description" | "icon" | "container" | "errorMessage" | "fieldInput" | "selectFieldIconWhenAddornmentIsActive"> & IPropertyEntrySelectRendererProps>;
