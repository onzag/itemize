        ...
        react_1.default.createElement("div", { className: props.classes.list, role: "presentation", onClick: props.onClose, onKeyDown: props.onClose },
            react_1.default.createElement(UserDataRetriever_1.default, null, (userData) => {
                if (userData.role === "ADMIN") {
                    return (react_1.default.createElement(react_1.default.Fragment, null,
                        react_1.default.createElement(mui_core_1.List, null,
                            react_1.default.createElement(Link_1.default, { to: "/cms", className: props.classes.listLink, propagateClicks: true },
                                react_1.default.createElement(LocationReader_1.default, null, (arg) => (react_1.default.createElement(mui_core_1.ListItem, { button: true, selected: arg.pathname === "/cms" },
                                    react_1.default.createElement(mui_core_1.ListItemIcon, null,
                                        react_1.default.createElement(mui_core_1.ImportantDevicesIcon, null)),
                                    react_1.default.createElement(module_1.ModuleProvider, { module: "cms" },
                                        react_1.default.createElement(mui_core_1.ListItemText, null,
            ...
            react_1.default.createElement(mui_core_1.List, null,
                react_1.default.createElement(Link_1.default, { to: "/", className: props.classes.listLink, propagateClicks: true },
                    react_1.default.createElement(LocationReader_1.default, null, (arg) => (react_1.default.createElement(mui_core_1.ListItem, { button: true, selected: arg.pathname === "/" },
                        react_1.default.createElement(mui_core_1.ListItemIcon, null,
                            react_1.default.createElement(mui_core_1.HomeIcon, null)),
                        react_1.default.createElement(mui_core_1.ListItemText, null,
                ...
                react_1.default.createElement(Link_1.default, { to: "/news", className: props.classes.listLink, propagateClicks: true },
                    react_1.default.createElement(LocationReader_1.default, null, (arg) => (react_1.default.createElement(mui_core_1.ListItem, { button: true, selected: arg.pathname === "/news" },
                        react_1.default.createElement(mui_core_1.ListItemIcon, null,
                            react_1.default.createElement(mui_core_1.LibraryBooksIcon, null)),
                        react_1.default.createElement(mui_core_1.ListItemText, null,
                            react_1.default.createElement(module_1.ModuleProvider, { module: "cms" },
