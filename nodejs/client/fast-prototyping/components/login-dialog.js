...
const loginDialogStyles = core_1.createStyles({
    welcomeTitle: {
        paddingBottom: "1rem",
        fontWeight: 300,
    },
...
exports.LoginDialog = core_1.withStyles(loginDialogStyles)((props) => {
        ...
        react_1.default.createElement(LogActioner_1.LogActioner, null, (actioner) => (react_1.default.createElement(I18nRead_1.default, { id: "login", capitalize: true }, (i18nLogin) => (react_1.default.createElement(dialog_1.DialogResponsive, { open: props.open, onClose: runManyFunctions.bind(null, [actioner.dismissError, actioner.cleanUnsafeFields, props.onClose]), title: i18nLogin },
            ...
            react_1.default.createElement("form", null,
                react_1.default.createElement(I18nReadMany_1.default, { data: [
                    ...
                    ] }, (i18nAltLabel, i18nAltPlaceholder) => (react_1.default.createElement(Entry_1.default, { id: "username", onChange: actioner.dismissError, showAsInvalid: !!actioner.error, ignoreErrors: true, altLabel: i18nAltLabel, altPlaceholder: i18nAltPlaceholder, icon: react_1.default.createElement(AccountCircle_1.default, null), autoFocus: true }))),
                ...
                react_1.default.createElement(util_1.ProgressingElement, { isProgressing: actioner.isLoggingIn, fullWidth: true, className: props.classes.loginButtonWrapper },
                    react_1.default.createElement(core_1.Button, { color: "primary", variant: "contained", size: "large", "aria-label": i18nLogin, startIcon: react_1.default.createElement(Done_1.default, null), onClick: actioner.login.bind(null, true), fullWidth: true }, i18nLogin)),
                react_1.default.createElement(I18nRead_1.default, { id: "forgot_password_question" }, (i18nForgotPassword) => (react_1.default.createElement(core_1.Button, { className: props.classes.forgotPasswordButton, color: "primary", variant: "text", size: "small", fullWidth: true, "aria-label": i18nForgotPassword, onClick: props.onRecoverRequest }, i18nForgotPassword))),
                react_1.default.createElement(core_1.Divider, { className: props.classes.divider }),
                react_1.default.createElement(I18nRead_1.default, { id: "signup_instead" }, (i18nSignupInstead) => (react_1.default.createElement(core_1.Button, { color: "secondary", variant: "text", fullWidth: true, "aria-label": i18nSignupInstead, onClick: props.onSignupRequest }, i18nSignupInstead)))),
