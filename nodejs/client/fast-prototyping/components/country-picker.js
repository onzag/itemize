...
class CountryPicker extends react_1.default.Component {
    ...
    render() {
        return (react_1.default.createElement(AppCountryRetriever_1.default, null, (countryData) => {
            const menu = this.state.anchorEl ? react_1.default.createElement(core_1.Menu, { anchorEl: this.state.anchorEl, keepMounted: false, open: !!this.state.anchorEl, onClose: this.handleMenuClose }, countryData.availableCountries.map((ac) => (react_1.default.createElement(core_1.MenuItem, { key: ac.code, selected: ac.code === countryData.currentCountry.code, onClick: this.handleCountryChange.bind(this, countryData.changeCountryTo, ac.code) },
                ac.emoji,
                " ",
                localization_1.capitalize(ac.native))))) : null;
            return (react_1.default.createElement(react_1.default.Fragment, null,
                react_1.default.createElement(core_1.Button, { classes: { root: this.props.className }, color: "inherit", startIcon: countryData.currentCountry.emoji, onClick: this.handleButtonSelectClick }, this.props.useCode ? countryData.currentCountry.code : countryData.currentCountry.native),
                menu));
        }));
    }
}
