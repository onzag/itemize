 ...
 * @returns a boolean
 */
function requestFieldsAreContained(requestFieldsSubset, requestFieldsOrValueMain) {
...
exports.requestFieldsAreContained = requestFieldsAreContained;
/**
 ...
 */
function deepMerge(gqlValueOrFieldsOverride, gqlValueOfFieldsOverriden) {
    ...
    Object.keys(gqlValueOrFieldsOverride).forEach((key) => {
        ...
        if (newObjMerge[key]) {
            newObjMerge[key] = deepMerge(gqlValueOrFieldsOverride[key], newObjMerge[key]);
        }
        else {
            // or add if not there
 ...
 */
function flattenRawGQLValueOrFields(fieldsOrValue) {
    if (!fieldsOrValue) {
...
exports.flattenRawGQLValueOrFields = flattenRawGQLValueOrFields;
