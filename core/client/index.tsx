...
(async () => {
  ...
  // We need to set the currency data to property definition
  // because of validation reasons; otherwise it will misbehave,
  // it is a bit of a quirk, but it works nevertheless
