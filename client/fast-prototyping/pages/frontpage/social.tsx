...
import { withStyles, createStyles, WithStyles, Typography, Paper, Theme, Container, IconButton, SvgIcon } from "@material-ui/core";
            ...
            <Paper className={props.classes.paper}>
              ...
              <Paper className={props.classes.paper2}>
                ...
                {vkURL ? <a href={vkURL} target="_blank">
                  <IconButton className={props.classes.button}>
                    <SvgIcon viewBox="-93 -93 1210 1210" className={props.classes.icon}>
                      {vksrc}
                    </SvgIcon>
                  </IconButton>
                </a> : null}
                {wechatURL ? <a href={wechatURL} target="_blank">
                  <IconButton className={props.classes.button}>
                    <SvgIcon viewBox="-40 -40 380 380" className={props.classes.icon}>
                      {wechatsrc}
                    </SvgIcon>
                  </IconButton>
                </a> : null}
