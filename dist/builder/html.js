...
async function buildHTML(rawConfig) {
    ...
    console.log("emiting " + safe_1.default.green(fileName), "BUILD_NUMBER:", safe_1.default.yellow(buildNumber));
    ...
    console.log("emiting " + safe_1.default.green(buildNumberFileName));
