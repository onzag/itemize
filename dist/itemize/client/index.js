...
async function initializeItemizeApp(mainComponent) {
    ...
    if (!storedLang || !storedCurrency || !storedCountry) {
        ...
        try {
            ...
            guessedUserData = {
                language: window.FALLBACK_LANGUAGE,
                country: window.FALLBACK_COUNTRY_CODE,
                currency: window.FALLBACK_CURRENCY,
            };
        }
        ...
        if (!window.SUPPORTED_LANGUAGES.includes(guessedLang)) {
    ...
    try {
        ...
        react_dom_1.default.render(<react_router_dom_1.Router history={exports.history}>
        <app_1.default initialRoot={initialRoot} langLocales={lang} initialCurrency={initialCurrency} initialCountry={initialCountry} mainComponent={mainComponent}/>
      </react_router_dom_1.Router>, document.getElementById("app"));
    }
    catch (err) {
