...
format_add_table = add table
format_add_thead = add table header
format_add_tbody = add table body
format_add_tfoot = add table footer
...
rich_table = table
rich_thead = table header
rich_tbody = table body
rich_tfoot = table footer
rich_tr = table row
rich_td = table column
rich_th = table column
...
error.TOKEN_EXPIRED = code/token has expired
...
format_add_table = agregar tabla
format_add_thead = agregar cabecera
format_add_tbody = agregar cuerpo
format_add_tfoot = agregar pie de tabla
