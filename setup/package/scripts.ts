...
export default {
  ...
  "test-development": "NODE_ENV=development mocha --require tsconfig-paths/register tests",
  "test-production": "NODE_ENV=production mocha --require tsconfig-paths/register tests",
